...
The code was used to create tidy data for "Human Activity Recognition Using Smartphones Dataset" provided for the assignment
...
The following data tables from the zip provided should be unzipped in the working directory - 
...
###Constructing Tidy Data

The following snippets of code combine test and training data for subjects and features, subsets the features data only for mean and standard deviation, reads the activity labels and creates a single tiny data frame combining subjects, features and activities
